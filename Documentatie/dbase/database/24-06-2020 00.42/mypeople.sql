...
INSERT INTO `meetup` (`id`, `userid`, `header`, `description`, `date`, `location`) VALUES
(1, 1, 'header', 'Een meet bij bobs enige echte auto shop.', '2020-06-26', ''),
(7, 1, 'header', 'Een meet bij bobs enige echte auto shop.', '0000-00-00', 'Utecht'),
(8, 1, 'Hentai koestraat', 'Wadduppoasdasd', '2020-06-14', 'Rotterdam'),
(9, 1, 'Marks firrari orgy', 'Sexy ferraris', '2001-09-11', 'Houten');
